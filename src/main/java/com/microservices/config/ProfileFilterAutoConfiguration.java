...
@EnableConfigurationProperties(ProfileFilterProperties.class)
public class ProfileFilterAutoConfiguration {
    @Bean
    @ConditionalOnMissingBean(ProfileFilter.class)
    public ProfileFilter profileFilter(ProfileFilterProperties props) {
        return new ProfileFilter(props);
    }
}
